            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <x-forms.textarea name="description"
                                      label="Описание">{{ $product->description ?? '' }}</x-forms.textarea>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    <x-forms.textarea name="meta_description"
                                      label="Meta Description">{{ $product->meta_description ?? '' }}</x-forms.textarea>
                </div>
                <div class="col-12">
                    <x-forms.textarea name="meta_keyword"
                                      label="Meta Keywords">{{ $product->meta_keyword ?? '' }}</x-forms.textarea>
                </div>
            </div>
            <div class="mt-3">
